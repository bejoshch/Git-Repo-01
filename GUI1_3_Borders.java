 ...
 * @version: 1
 */
public class GUI1_3_Borders extends JFrame 
{
	...
	private NonroutineServcesPanel nrsp;		// to reference the nonroutine service panel
    ...
    */
    ...
    public GUI1_3_Borders()
    {
    	...
    	nrsp = new NonroutineServcesPanel();
    	myPanel1.add(nrsp, BorderLayout.CENTER);
    	//myPanel1.add(new BorderLayout());
    	exitButton = new JButton("Exit");
    	myPanel1.add(exitButton, BorderLayout.SOUTH);
    	
    	myTabbedPane.addTab("Charges", null, myPanel1, "Select the charges to apply");
